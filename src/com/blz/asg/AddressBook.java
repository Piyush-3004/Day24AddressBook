	...
	public static void main(String[] args) {
		...
		while (op != 0) {
			...
			if (op == 0)
				break;
			System.out.println(
					"Enter 0 to Exit,1 to add new book & contact ,2 to view ,3 to edit ,4 to delete,5 to search by city,6 to get count, 7 to sort on name, 8 to sort on city/statr/zipCode");
